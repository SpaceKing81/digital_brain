...
pub const AXION_NEG_COLOR:Color = Color::new(0.6, 0.2, 0.0, 0.5);
pub const AXION_POS_COLOR:Color = Color::new(0.1, 0.5, 0.3, 0.5);
pub const AXION_INPUT_COLOR:Color = Color::new(0.9, 0.3, 0.0, 0.5);